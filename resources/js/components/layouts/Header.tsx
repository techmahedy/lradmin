                ...
                <div className="app-header-content"> 
                    ...
                    <div className="col-auto">
                        <a id="sidepanel-toggler" className="sidepanel-toggler d-inline-block d-xl-none" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" role="img"><title>Menu</title></svg>
                        </a>
                    </div>
                    ...
                    <div className="app-utilities col-auto">
                                ...
                                <div className="dropdown-menu-content">
                                   <div className="item p-3">
                                        <div className="row gx-2 justify-content-between align-items-center">
                                            <div className="col-auto">
                                               <img className="profile-image" src="https://avatars.githubusercontent.com/u/31318802?s=40&v=4" alt=""/>
                                            </div>
                                            <div className="col">
                                                <div className="info"> 
                        ...
                        <div className="app-utility-item app-user-dropdown dropdown">
                            <a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="https://avatars.githubusercontent.com/u/31318802?s=40&v=4" alt="user profile"/></a>
        ...
        <div id="app-sidepanel" className="app-sidepanel"> 
            ...
            <div className="sidepanel-inner d-flex flex-column">
                ...
                <div className="app-branding">
                    <NavLink className="app-logo" to="/"><img className="logo-icon me-2" src="https://avatars.githubusercontent.com/u/31318802?s=40&v=4" alt="logo"/><span className="logo-text">SYSTEM ADMIN</span></NavLink>
                </div>
                <Sidebar/>
            </div>
        </div>
